---
bcos_type: index
id: DJBRAIN-CELL-CONTEXT-INDEX
title: "Context Index — djbrain Cell"
status: active
created: 2026-07-05
...
| `apps/djbrain/README.md` | the app package |
...
| Touching djbrain content | `apps/djbrain/CONTEXT_INDEX.md` |
...
| `apps/djbrain/` | the active domain capability |
