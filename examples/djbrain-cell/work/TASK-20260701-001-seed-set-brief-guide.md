...
title: "Seed the set-brief guide and first genre notes in djbrain"
status: done
work_status: done
created: 2026-07-01
...
djbrain answers its first real question: "write a set brief for a booking" —
...
- `../decisions/DECISION-20260701-001-djbrain-app-package.md` — app-package placement
- `../apps/djbrain/CONTEXT_INDEX.md` — where content routes inside the package

## Allowed Actions

- Create files under `apps/djbrain/knowledge/` and `apps/djbrain/prompts/`.
...
- `apps/djbrain/prompts/set-brief.prompt.md`
...
changed_files:
  - apps/djbrain/knowledge/genre-notes.md: house + techno seeded
  - apps/djbrain/knowledge/venue-profiles.md: three fictional venues profiled
  - apps/djbrain/prompts/set-brief.prompt.md: canonical brief prompt, text-only per gate
validation:
  git_diff_check: pass
