---
bcos_type: doc
id: SETBRAIN-CELL-PROJECT
title: "setbrain Cell Project Context"
status: active
created: 2026-07-05
...
domain capability: **setbrain**, the team's knowledge brain for genres, venues,
and set descriptions.

## Scope

Intake, executable work, decisions, human gates, reports, proofs, handoffs,
history, distilled library patterns, playbooks, and the `apps/setbrain/`
package.
...
- Raw domain knowledge stays inside `apps/setbrain/`; the Cell root stays
  governance-only.
