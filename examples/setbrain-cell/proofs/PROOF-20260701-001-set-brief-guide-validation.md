...
TASK-20260701-001 is complete: setbrain can answer "write a set brief" with a
canonical format backed by genre notes, under the text-only posture of
HUMAN-GATE-20260630-001.

## Evidence

1. **Deliverables exist** — `apps/setbrain/knowledge/genre-notes.md`,
   `apps/setbrain/knowledge/venue-profiles.md`,
   `apps/setbrain/prompts/set-brief.prompt.md`, each with routing frontmatter.
...
3. **First real use** — Sam produced a brief for the fictional "Harbor Loft"
   booking using only setbrain content; the promoter accepted it without a
