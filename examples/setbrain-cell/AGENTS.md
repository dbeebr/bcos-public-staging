---
bcos_type: doc
id: SETBRAIN-CELL-AGENTS
title: "setbrain Cell Agent Contract"
status: active
created: 2026-07-05
...
| setbrain domain content | `apps/setbrain/` (read its `CONTEXT_INDEX.md` first) |
