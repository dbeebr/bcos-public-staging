...
kind: reference
surface: project
id: TEAMCELL-GATE-MATRIX
title: "Teamcell Gate Decision Matrix"
status: active
created: 2026-09-22
...
> Kit-local copy so every installed Cell has this table without depending on
> distribution-root access after install (TASK-20260911-001 R3 follow-up:
> "docs/teamcell-gate-matrix.md wird in installierten Zellen referenziert,
> aber nicht mitinstalliert"). Content is the rule text itself; source of
> truth for edits is the public distribution's docs/teamcell-gate-matrix.md —
