---
bcos_type: schema
id: TEAMCELL-KIT-SCHEMA-COMPLETION-RECORD
title: "Completion Record Schema (kit copy)"
status: active
created: 2026-09-22
...
> Kit-local copy, shipped so `docs/teamcell-gate-matrix.md`'s own in-kit
> reference ("Standard Completion Record") resolves inside an installed
> Cell. Source of truth for edits is the public distribution's
> schemas/completion-record.schema.md — update there first, then re-sync
> here.
