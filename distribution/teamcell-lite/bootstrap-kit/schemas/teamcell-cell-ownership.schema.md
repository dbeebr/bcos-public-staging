---
bcos_type: schema
id: TEAMCELL-KIT-SCHEMA-CELL-OWNERSHIP
title: "Teamcell Cell Ownership Schema (kit copy)"
status: active
created: 2026-09-22
...
> Kit-local copy, shipped so `docs/teamcell-gate-matrix.md` and
> `.bcos/CELL-GOVERNANCE.yaml.template`'s own in-kit references resolve inside
> an installed Cell. Source of truth for edits is the public distribution's
> schemas/teamcell-cell-ownership.schema.md — update there first, then
> re-sync here.
